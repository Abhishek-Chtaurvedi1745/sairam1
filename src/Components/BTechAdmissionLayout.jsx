      ...
      <div className="relative min-h-screen bg-gray-50">
        ...
        <nav className="bg-white border-b px-[8%] py-3 flex gap-6 overflow-x-auto whitespace-nowrap scrollbar-none shadow-sm">
          ...
          <a
            ...
            className="text-sm text-gray-600 font-medium hover:text-blue-700 transition"
          >
            Fees of Private Engineering Colleges
          </a>
          <a
            href="#quota"
            className="text-sm text-gray-600 font-medium hover:text-blue-700 transition"
          >
            Institutions For Management Quota
          </a>
          <a
            href="#process"
            className="text-sm text-gray-600 font-medium hover:text-blue-700 transition"
          ...
          <a
            ...
            className="text-sm text-gray-600 font-medium hover:text-blue-700 transition"
          >
            Colleges for Admission in B-Tech
          </a>
        </nav>
          ...
          <section className="md:col-span-7 flex flex-col gap-6">
            ...
            <div className="max-w-[900px] space-y-16 text-gray-700 py-6">
              ...
              <section id="process">
                ...
                <div className="space-y-4 leading-relaxed">
                  <p>
                    Admission to B-Tech in {cityName} is generally based on entrance
                    exam scores such as JEE Main, state CET, or institute-level exams.
                  </p>
                  {process.map((para, i) => (
                    <p key={i}>{para}</p>
                  ))}
              ...
              <section id="colleges">
                ...
                <div className="space-y-4 leading-relaxed">
                  ...
                  <p>
                    Students should choose colleges based on budget, entrance score,
                    branch preference, and location.
                  </p>
                  <p>
          ...
          <aside className="md:col-span-4 flex flex-col gap-6">
            <div className="bg-white rounded-2xl p-7 text-center shadow-lg hover:shadow-2xl transition border border-gray-100">
              ...
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                Get admission in top engineering colleges across India with expert
...
export default BTechAdmissionLayout;
